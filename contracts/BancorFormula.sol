...
//   function initialize(address creator) external override {}
  /**
  ...
  */
    ...
    returns (uint256)
  {
    ...
    (result, precision) = power(baseN, _connectorBalance, SafeCast.toUint32(_connectorWeight), MAX_WEIGHT);
  ...
  */
    ...
    returns (uint256)
  {
    ...
    // require(_connectorBalance > 0);
    require(_connectorWeight > 0, "weight");
    require(_connectorWeight <= MAX_WEIGHT, "max weight");
    require(_sellAmount <= _supply, "sell");
    ...
    (result, precision) = power(_supply, baseD, MAX_WEIGHT, SafeCast.toUint32(_connectorWeight));
